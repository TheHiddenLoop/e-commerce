...
import { addProduct, allProduct, viewProduct, sellingProducts, removeProduct, review } from "../controllers/productControllers.js";
...
productRouter.post("/review/:productId", protectRoute, review);
